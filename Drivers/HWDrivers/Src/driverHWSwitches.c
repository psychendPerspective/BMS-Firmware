...
const driverHWSwitchesPortStruct driverHWSwitchesPorts[NoOfSwitches] =			// Hold all status configuration data
{
	...
	{GPIOB,RCC_AHBENR_GPIOBEN,GPIO_PIN_10,GPIO_MODE_OUTPUT_PP,GPIO_NOPULL},		// SWITCH_DISCHARGE   //HV+ contactor
	{GPIOB,RCC_AHBENR_GPIOBEN,GPIO_PIN_1,GPIO_MODE_OUTPUT_PP,GPIO_NOPULL},		// SWITCH_DISCHARGEHV //HV- contactor
